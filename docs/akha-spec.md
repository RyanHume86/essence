# Akha: build spec for recurring tasks, calm overdue handling, and data ownership
...
1. In-app reminders only. When Akha is open, surface due and nearly-due tasks prominently. Honest about its limits, zero infrastructure.
