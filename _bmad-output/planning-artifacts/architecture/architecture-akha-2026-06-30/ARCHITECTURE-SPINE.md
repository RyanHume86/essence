...
scope: 'Akha v1 whole-product architecture — a calm task companion on React/Vite, part-brownfield over a shipped Base44 codebase. Fixes the invariants that keep the four surfaces (Focus, Plan, Archive, Settings) and the core src/lib modules from diverging, and resolves the forks the PRD/UX deferred to this phase.'
status: final
created: '2026-06-30'
updated: '2026-06-30'
