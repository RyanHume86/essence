...
- [x] **Task 2 — Build the onboarding flow (AC: 2, 3)**
  ...
  - [x] Welcome step: warm Playfair line naming the space (`This space is yours, {name}.`), `<Companion />` for warmth, `.btn-accent-3d` "Enter Akha" → `setOnboarded(true)`.
